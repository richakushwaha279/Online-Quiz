...
contract('Quiz', function(accounts) {
  ...
  it("Only quiz master can unveil questions!", function() {
      ...
      Quiz.deployed().then( async function(instance){
        ...
        await instance.registerPlayers(150, {from: accounts[3]});
        return instance;
      }).then(async function(instance){

        await instance.registerPlayers(120, {from: accounts[4]});
        return instance;
      }).then(async function(instance){

await sleep(30000);
		await instance.unveilQuestion({from: accounts[2]});
         return instance;
      }).then(async function(instance){
...
await sleep(30000);
      	await instance.unveilQuestion({from: accounts[3]});
         return instance;
      }).then(async function(instance){
// await sleep(30000);
